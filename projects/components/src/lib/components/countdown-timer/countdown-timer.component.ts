...
export class CountdownTimerComponent implements OnInit, OnDestroy {
  ...
  // MODULUS
  // Neutral modulus
  _dayModulus = (secondsLeft: any) => secondsLeft;
  ...
  _hourModulus = (secondsLeft: number) => (secondsLeft % this._dayDivisor);
  _minuteModulus = (secondsLeft: number) => (secondsLeft % this._hourDivisor);
  _secondModulus = (secondsLeft: number) => (secondsLeft % this._minuteDivisor);
